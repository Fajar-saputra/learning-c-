...
public:
    // Constructor
    Pembeli(const std::string& m_nama = "belum ada", int jumlahBeli = 0, const std::string& noTlp = "belum ada", const std::string& alamat = "tidak ada");
