...
Penjual::Penjual(const std::string& nama, int umur, int lamaKerja, std::string alamat, const std::string& noTelp)
...
void Penjual::cetakInfoPenjual() const {
    std::cout << "Nama\t\t: " << getNama() << std::endl;
    std::cout << "Umur\t\t: " << getUmur() << std::endl;
    std::cout << "Lama kerja\t: " << getLamaKerja() << " tahun" << std::endl;
    std::cout << "Alamat\t\t: " << getAlamat() << std::endl;
    std::cout << "No. Telp\t: " << getNoTelp() << std::endl << std::endl;
}
